...
export const riskQuestions: RiskQuestion[] = [
  {
    ...
    options: [
      {
        value: "soon",
        label: "1년 안에 쓸 수도 있어요",
        note: "생활비나 큰 지출에 필요할 수 있어요.",
        score: 0,
      },
      {
        value: "mid",
        label: "3년 정도는 안 써요",
        note: "중간 정도의 기다림은 가능해요.",
        score: 1,
      },
      {
        value: "long",
        label: "5년 넘게 안 써도 돼요",
        note: "오래 기다릴 수 있는 여유 자금이에요.",
        score: 2,
      },
    ],
  },
  {
    ...
    options: [
      {
        value: "sell",
        label: "불안해서 대부분 팔 것 같아요",
        note: "큰 하락을 피하는 조건이 우선이에요.",
        score: 0,
      },
      {
        value: "wait",
        label: "이유를 확인하고 기다려요",
        note: "좋은 회사라면 회복을 기다릴 수 있어요.",
        score: 1,
      },
      {
        value: "buy",
        label: "회사가 멀쩡하면 더 살 수 있어요",
        note: "큰 가격 변동을 감수할 수 있어요.",
        score: 2,
      },
    ],
  },
  {
    ...
    options: [
      {
        value: "protect",
        label: "내 돈을 크게 잃지 않는 것",
        note: "흑자와 재무 안전을 먼저 봐요.",
        score: 0,
      },
      {
        value: "balance",
      ...
      {
        value: "growth",
        label: "큰 성장 기회를 놓치지 않는 것",
        note: "적자나 큰 변동도 일부 허용해요.",
        score: 2,
      },
    ],
  },
  {
    ...
    options: [
      ...
      },
      {
        value: "some",
        label: "일부만 섞어도 괜찮아요",
        note: "안정적인 후보와 함께 비교해요.",
        score: 1,
      },
      {
        value: "allow",
        label: "네, 초기 성장 회사를 찾고 싶어요",
        note: "성공 가능성과 생존 자금을 함께 봐요.",
        score: 2,
      },
    ],
  },
    ...
    options: [
      {
        value: "none",
        label: "거의 처음이에요",
        note: "설명과 안전 조건을 더 많이 보여드려요.",
        score: 0,
      },
      {
        value: "some",
        label: "몇 번 겪어봤어요",
        note: "위험과 기회를 함께 비교해요.",
        score: 1,
      },
      {
        value: "often",
        label: "여러 번 겪고도 투자했어요",
        note: "변동이 큰 후보까지 볼 수 있어요.",
        score: 2,
      },
    ],
  },
